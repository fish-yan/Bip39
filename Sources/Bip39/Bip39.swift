...
public enum Bip39Error: LocalizedError {
...
public class BIP39 {
    ...
    private static func entropyOf(size: Int) throws -> Data {
        ...
        guard
            ...
            throw Bip39Error.noEntropyError("BIP39. \(!isCorrectSize ? "Requested entropy of wrong bits size: \(size). Expected: 128 <= size <= 256, size % 32 == 0." : "Failed to generate \(randomBytesCount) of random bytes.")")
        }
        return entropy
    }
